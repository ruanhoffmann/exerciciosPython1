"""
3) Faça uma função para ajudar o professor Fachini a calcular as notas dos seus queridos alunos. A função deve receber como parâmetro as 3 notas de um estudante.
